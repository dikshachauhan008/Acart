...
public class ProductController {
	...
	public void saveProduct(@RequestParam("file") MultipartFile file, @RequestParam("product") String product, @RequestParam("sellerId") String sellerId) throws JsonParseException, JsonMappingException, IOException {
